...
export default function LandingPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Opciones de movilidad verde para llegar al carnaval",
            ...
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                ...
                <div className="flex gap-2">
                  ...
                  <Badge className="bg-yellow-400/20 text-yellow-300 border-yellow-400/30 px-4 py-2">
                    #Recicla
                  </Badge>
                </div>
              </div>
        ...
        <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-white/15">
          <div className="max-w-7xl mx-auto text-center">
            <div className="flex justify-center items-center mb-6">
              <div className="text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent mr-4">
                N
              </div>
              <div className="text-2xl font-bold text-black bg-white rounded-sm px-1">
                &
              </div>
              <div className="text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent ml-1">
                B
              </div>
            </div>
